...
//        sm.seoulData();
	...
	public void seoulAttractions()
	{
		...
		try
		{
			...
			FileOutputStream fos = new FileOutputStream("c:\\java_data\\location.txt");
	...
	{
		ArrayList<SeoulHotelVO> list = new ArrayList<SeoulHotelVO>();
		//DataDAO dao=new DataDAO();
		try
		{
			int k=1;
			...
			FileOutputStream fos = new FileOutputStream("c:\\java_data\\hotel.txt");
			ObjectOutputStream oos = new ObjectOutputStream(fos);
			oos.writeObject(list);
			oos.close();
			fos.close();
	...
	{
		ArrayList<SeoulNatureVO> list = new ArrayList<SeoulNatureVO>();
		//DataDAO dao=new DataDAO();
		try
		{
			int k=1;
			...
			FileOutputStream fos = new FileOutputStream("c:\\java_data\\nature.txt");
			ObjectOutputStream oos = new ObjectOutputStream(fos);
			oos.writeObject(list);
			oos.close();
			fos.close();
